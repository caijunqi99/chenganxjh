...
class Ownshop extends AdminControl {
    ...
    public function add() {
        if (!request()->isPost()) {
            ...
            $this->success('操作成功', url('School/ownshop/index'));
            return;
        }
    }
    ...
    public function edit() {
        ...
        if (!request()->isPost()) {
            ...
            $this->error('操作成功', url('School/ownshop/index'));
        }
    }
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'index',
                'text' => '管理',
                'url' => url('School/Ownshop/index')
            ), array(
                'name' => 'add',
                'text' => '新增',
                'url' => url('School/Ownshop/add')
            )
        );
        ...
        if (request()->action() == 'bind_class') {
            $menu_array[] = array(
                'name' => 'bind_class',
                'text' => '经营类目',
                'url' => url('School/Ownshop/bind_class')
            );
        }
        return $menu_array;
    }
