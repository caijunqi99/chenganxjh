...
class Ads extends AdminControl {
    ...
    public function _initialize() {
        parent::_initialize();
        Lang::load(APP_PATH . 'school/lang/zh-cn/adv.lang.php');
        //获取当前角色对当前子目录的权限
    ...
    public function ap_add() {
        ...
        if (!request()->isPost()) {
            ...
            if ($result) {
                ...
                $this->success(lang('ap_add_succ'), url('School/Ads/ap_manage'));
            } else {
