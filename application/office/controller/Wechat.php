...
class Wechat extends AdminControl
{
    public function _initialize()
    {
        ...
        Lang::load(APP_PATH . 'office/lang/zh-cn/wechat.lang.php');
    }
    ...
    public function menu_add()
    {
        if (!request()->isPost()) {
            ...
            if($result){
                $this->success(lang('ds_common_save_succ'),'office/Wechat/menu');
            }else{
    ...
    public function k_text(){
        ...
        if(empty($wechat)){
            $this->error('请先在公众号配置添加公众号，才能进行文本回复管理', 'office/Wechat/setting');
        }
    ...
    public function text_form(){
        ...
        if(empty($wechat)){
            $this->error('请先在公众号配置添加公众号，才能添加文本回复', 'office/Wechat/setting');
        }
        if(\request()->isPost()){
            $kid = input('param.id');
            ...
            $row ? $this->success("添加成功",'office/Wechat/k_text') : $this->error("添加失败",'office/Wechat/k_text');
            exit;
        }
        //编辑状态
        $id = input('param.id');
