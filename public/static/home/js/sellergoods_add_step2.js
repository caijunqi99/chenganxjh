...
//    });
    ...
    $('div[nctype="mobile_pannel"]').on('click', '[nctype="mp_edit"]', function(){
        ...
        $(this).parents('.module:first').html('')
            ...
            .append('<div class="dssc-mea-text" nctype="mea_txt"></div>')
            ...
            .append('<div class="button"><a class="dssc-btn dssc-btn-blue" nctype="meat_edit_submit" href="javascript:void(0);">确认</a><a class="dssc-btn ml10" nctype="meat_edit_cancel" href="javascript:void(0);">取消</a></div>')
