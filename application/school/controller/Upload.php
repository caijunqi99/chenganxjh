...
class Upload extends AdminControl
{
    ...
    {
        parent::_initialize();
        Lang::load(APP_PATH . 'school/lang/zh-cn/upload.lang.php');
    }
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'default_thumb', 'text' => '默认图片', 'url' => url('School/Upload/default_thumb')
            ), array(
                'name' => 'upload_type', 'text' => '上传设置', 'url' => url('School/Upload/upload_type')
            )
        );
        return $menu_array;
    }
