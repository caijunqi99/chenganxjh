...
$(function() {
    ...
    o.loadInit({url: ApiUrl + "/Goods/goods_evaluate.html", getparam: {goods_id: goods_id}, tmplid: "product_ecaluation_script", containerobj: $("#product_evaluation_html"), iIntervalId: true, callback: function() {
            callback()
        }});
    ...
    $(".nctouch-tag-nav").find("a").click(function() {
        ...
        o.loadInit({url: ApiUrl + "/Goods/goods_evaluate.html", getparam: {goods_id: goods_id, type: i}, tmplid: "product_ecaluation_script", containerobj: $("#product_evaluation_html"), iIntervalId: true, callback: function() {
                callback()
            }});
...
function callback() {
    $(".goods_geval").on("click", "a", function() {
        ...
        Swipe(i[0], {speed: 400, auto: 3e3, continuous: false, disableScroll: false, stopPropagation: false, callback: function(o, i) {
