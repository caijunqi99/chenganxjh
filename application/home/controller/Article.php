...
class Article extends BaseMall
{
    public function _initialize()
    {
        ...
        Lang::load(APP_PATH.'home/lang/zh-cn/article.lang.php');
    ...
    public function index()
    {
        ...
        if (empty($ac_id)) {
            $this->error(lang('para_error'));//'缺少参数:文章类别编号'
        }
        /**
         * 得到导航ID
         */
        ...
        $article_class = $article_class_model->getOneClass($ac_id);
    ...
    public function show()
    {
        ...
        if (empty($article_id)) {
            $this->error(lang('para_error'));//'缺少参数:文章编号'
        }
        /**
         * 根据文章编号获取文章信息
         */
