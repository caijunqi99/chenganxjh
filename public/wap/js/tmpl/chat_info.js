...
var nodeSiteUrl = "";
var memberInfo = {};
var resourceSiteUrl = WapSiteUrl;
...
$(function () {
    $.getJSON(ApiUrl + "/Memberchat/get_node_info.html", {
        key: key,
        u_id: t_id,
    ...
    function (t) {
        checkLogin(t.login);
        e(t.result);
        if (!$.isEmptyObject(t.result.chat_goods)) {
            var a = t.result.chat_goods;
    ...
    var e = function (e) {
        ...
        function s() {
            ...
            function s(e) {
                if (t === 1) {
                    $.ajax({
                        type: "post",
                        url: ApiUrl + "/Memberchat/send_msg.html",
                        data: e,
                        dataType: "json",
                        success: function (e) {
                            if (e.code == 200) {
            ...
            function o(e) {
                ...
                for (var a in e) {
                    var s = e[a];
                    if (e[a].t_name != username || e[a].f_id != t_id) {
                        continue;
                    }
                    t = a;
        ...
        for (var i in smilies_array[1]) {
            ...
            var r = '<img title="' + o[6] + '" alt="' + o[6] + '" data-sign="' + o[1] + '" src="' + resourceSiteUrl + "/../static/plugins/js/smilies/images/" + o[2] + '">';
        ...
        $("#chat_msg_log").click(function () {
            $.ajax({
                type: "post",
                url: ApiUrl + "/Memberchat/get_chat_log.html?pagesize=50",
                data: {
                    key: key,
                    t_id: t_id,
                    t: 30
                ...
                success: function (e) {
                    if (e.code == 200) {
                        ...
                        e.result.list.reverse();
                        $("#chat_msg_html").html("");
                        for (var t = 0; t < e.result.list.length; t++) {
                            var a = e.result.list[t];
                            if (a.f_id != t_id) {
                                var s = {};
                                s.class = "msg-me";
        ...
        function n(e) {
            ...
            if (!$.isEmptyObject(e.goods_info)) {
                var a = e.goods_info;
                var t = '<div class="nctouch-chat-product"> <a href="' + WapSiteUrl + "/tmpl/product_detail.html?goods_id=" + a.goods_id + '" target="_blank"><div class="goods-pic"><img src="' + a.pic + '" alt=""/></div><div class="goods-info"><div class="goods-name">' + a.goods_name + '</div><div class="goods-price">￥' + a.goods_promotion_price + "</div></div></a> </div>";
                $("#chat_msg_html").append(t)
            }
        ...
        function c(e) {
            if (typeof smilies_array !== "undefined") {
                ...
                for (var t in smilies_array[1]) {
                    ...
                    var i = '<img title="' + a[6] + '" alt="' + a[6] + '" src="' + resourceSiteUrl + "/../static/plugins/js/smilies/images/" + a[2] + '">';
                    e = e.replace(s, i)
                }
            }
            return e
