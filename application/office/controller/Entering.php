                ...
                if($_FILES["file"]["size"] < 8*1024*1024){
                    ...
                    else
                    {
                        if (!empty($_FILES['file']['tmp_name'])) {
                            ...
                            $base_url=BASE_UPLOAD_PATH . '/Office/entering/';
                        ...
                        $name_dir= '/Office/entering/'.$info->getFilename();
                        $file_dir=UPLOAD_SITE_URL.'/Office/entering/'.$info->getFilename();
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'entering',
                'text' => '线下资金转账凭证',
                'url' => url('office/Entering/entering')
            ),
            array(
                'name' => 'fail',
                'text' => '导入失败列表',
                'url' => url('office/Entering/fail')
            ),
            array(
                'name' => 'success',
                'text' => '导入成功列表',
                'url' => url('office/Entering/success')
            )
