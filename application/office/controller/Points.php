...
class Points extends AdminControl {
    ...
    public function _initialize() {
        parent::_initialize();
        Lang::load(APP_PATH . 'office/lang/zh-cn/points.lang.php');
    }
    ...
    public function index() {
        if (!request()->isPost()) {
            ...
            $insert_arr['pl_adminname']=session('office_name');
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'index',
                'text' => '管理',
                'url' => url('office/Points/index')
            ),
            array(
                'name' => 'pointslog',
                'text' => '积分明细',
                'url' => url('office/Points/pointslog')
            )
        );
        return $menu_array;
    }
