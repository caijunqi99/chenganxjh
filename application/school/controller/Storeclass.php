...
class Storeclass extends AdminControl {
    ...
    public function _initialize() {
        parent::_initialize();
        Lang::load(APP_PATH . 'school/lang/zh-cn/storeclass.lang.php');
    }
    ...
    public function store_class_add() {
        ...
        if (!request()->isPost()) {
            ...
            if ($result) {
                ...
                $this->success(lang('ds_common_save_succ'), url('School/Storeclass/store_class'));
            } else {
    ...
    public function store_class_del() {
        ...
        $this->error(lang('ds_common_del_fail'), url('School/Storeclass/store_class'));
    }
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'store_class',
                'text' => '管理',
                'url' => url('School/Storeclass/store_class')
            ),
        );
        ...
        if (request()->action() == 'store_class_add' || request()->action() == 'store_class') {
            $menu_array[] = array(
                ...
                'text' => '新增',
                'url' => url('School/Storeclass/store_class_add')
            );
        }
        if (request()->action() == 'store_class_edit') {
            $menu_array[] = array(
                ...
                'text' => '编辑',
                'url' => url('School/Storeclass/store_class_edit')
            );
        }
        return $menu_array;
    }
