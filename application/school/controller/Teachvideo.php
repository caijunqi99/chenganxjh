...
//        }
    ...
    public function add() {
        ...
        if (!request()->isPost()) {
            ...
            if ($result) {
                $this->success(lang('ds_common_save_succ'), url('School/Teachvideo/index'));
            } else {
                $this->error(lang('ds_common_save_fail'), url('School/Teachvideo/index'));
            }
    ...
    public function image($picture){
        ...
        {
            $this->error(lang("格式不正确"), url('School/Teachvideo/index'));
        }
        if (!empty($_FILES['video_filename']['name'])) {
            ...
            if($upload){
                ...
                $this->error(lang("上传视频封面图失败"), url('School/Teachvideo/index'));
            }
        }
    }
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'index',
                'text' => '管理',
                'url' => url('School/Teachvideo/index')
            ),
        );
        ...
        if (request()->action() == 'pass') {
            $menu_array[] = array(
                'name' => 'pass',
                'text' => '审核',
                'url' => url('School/Teachvideo/pass')
            );
        }
        return $menu_array;
    }
