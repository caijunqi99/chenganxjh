...
class wxpay{
    ...
    public function get_payurls() {
        ...
        require_once APP_PATH .ATTACH_PATH.'/api/payment/wxpay/WxPay.NativePay.php';
        require_once APP_PATH .ATTACH_PATH.'/api/payment/wxpay/log.php';
    ...
    public function get_payurl() {
       ...
       /* $logHandler= new CLogFileHandler(ROOT_PATH.'runtime/log/wxpay/'.date('Y-m-d').'.log');
        $Logwx = Logwx::Init($logHandler, 15);*/
...
//         $input->SetBody(C('site_name').'订单');
        ...
        $input->SetGoods_tag('');
        $input->SetNotify_url(SHOP_SITE_URL.'/payment/wxpay_notify');
...
//         print_R($result);exit;
        ...
        trace('unifiedorder-:'. json_encode($result),'debug');
