...
class Memberfavorites extends BaseMember {
    ...
    public function _initialize() {
        parent::_initialize();
        Lang::load(APP_PATH . 'home/lang/zh-cn/memberfavorites.lang.php');
    }
    ...
    public function delfavorites() {
        if (!input('param.fav_id') || !input('param.type')) {
            showDialog(lang('member_favorite_del_fail'), '', 'error');
        }
        ...
        if (!empty($fav_arr) && is_array($fav_arr)) {
            $favorites_list = $favorites_model->getFavoritesList(array(
            ...
            if (!empty($favorites_list) && is_array($favorites_list)) {
                ...
                if (!empty($fav_arr) && $result) {
                    ...
                    showDialog(lang('favorite_del_success'), url('Memberfavorites/fglist', ['show' => input('param.show')]), 'succ');
                }
            } else {
                showDialog(lang('favorite_del_fail'), '', 'error');
            }
        } else {
            showDialog(lang('member_favorite_del_fail'), '', 'error');
        }
    ...
    public function checkLogin() {
        parent::checkLogin(); // TODO: Change the autogenerated stub
    }
