...
class Config extends AdminControl {
    ...
    public function _initialize() {
        parent::_initialize();
        Lang::load(APP_PATH . 'office/lang/zh-cn/config.lang.php');
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'index',
                'text' => '时长/分成/副账号设置',
                'url' => url('office/Config/index')
            ),
            array(
                'name' => 'channel',
                'text' => '渠道标识管理',
                'url' => url('office/Config/channel')
            ),
            array(
                'name' => 'version',
                'text' => '版本管理',
                'url' => url('office/Config/version')
            ),
//            array(
//                'name' => 'base',
//                'text' => '站点设置',
//                'url' => url('office/Config/base')
//            ),
//            array(
//                'name' => 'dump',
//                'text' => '防灌水设置',
//                'url' => url('office/Config/dump')
//            ),
        );
        return $menu_array;
    }
