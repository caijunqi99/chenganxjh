...
//            dump($this->permission);exit;
    ...
    public function setMenuList() {
        ...
        /*if($menu_list['school']){
            ...
            $menu_list["school"]['children']['schoolfood'] = [
                "permid" => 129,
                "pid" => 27,
                "c_name" => "食谱管理",
                "name" => "schoolfood",
...
//        halt($this->permission);
        ...
        $tmp = array('Index','Schooldesc','Dashboard','Schoolbus','Schoolfood','Coursemanage','Login','Schoolinfo','Classesinfo','Studentinfo','Mlselection','Common','Membercommon');
