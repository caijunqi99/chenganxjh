<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:110:"E:\phpStudy\PHPTutorial\WWW\chenganxjh\public/../application/admin\view\statmarketing\marketing_promotion.html";i:1514855480;s:90:"E:\phpStudy\PHPTutorial\WWW\chenganxjh\public/../application/admin\view\public\header.html";i:1514528328;s:95:"E:\phpStudy\PHPTutorial\WWW\chenganxjh\public/../application/admin\view\public\admin_items.html";i:1514541233;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="stat-info">
    ...
    <span>下单金额：
    <strong><?php echo dsPriceFormat($statcount['orderamount']); ?></strong>
    元 </span>
</div>
...
function getLineLabels(stattype){
    ...
    if(!$("#"+stattype+'_div').html()){
        $("#"+stattype+'_div').load(ADMIN_URL+'statmarketing/promotiontrend?search_type='+search_type+'&stattype='+stattype+'&t=<?php echo $searchtime; ?>');
    }
}
</script>