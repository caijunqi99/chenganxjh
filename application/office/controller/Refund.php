...
class Refund extends AdminControl
{
    ...
    {
        parent::_initialize();
        Lang::load(APP_PATH . 'office/lang/zh-cn/refund.lang.php');
        //向模板页面输出退款退货状态
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'refund_manage', 'text' => '待处理', 'url' => url('office/Refund/refund_manage')
            ), array(
                'name' => 'refund_all', 'text' => '所有记录', 'url' => url('office/Refund/refund_all')
            ), array(
                'name' => 'reason', 'text' => '退款退货原因', 'url' => url('office/Refund/reason')
            ),
        );
