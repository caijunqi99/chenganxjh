        ...
        <div class="mc">
            <table cellpadding="0" cellspacing="0" class="system_table">
                <tbody><tr>
                    ...
                    <tr>
                        <td class="gray_bg">官方网站:</td>
                        <td><a href="http://www.csdeshang.com" target="_blank">官方网站</a></td>
                        <td class="gray_bg">官方论坛:</td>
                        <td><a href="http://bbs.csdeshang.com" target="_blank">交流论坛</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
