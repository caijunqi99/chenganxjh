...
class Brand extends BaseMall {
    ...
    public function _initialize() {
        Lang::load(APP_PATH . 'home/lang/zh-cn/brand.lang.php');
    ...
    public function index() {
        ...
        $brand_c_list = db('brand')->where(array('brand_apply' => '1'))->order('brand_sort asc')->select();
    ...
    private function _getTopClass($goods_class, $gc_id) {
        ...
        return $goods_class[$gc_id]['gc_parent_id'] == 0 ? $goods_class[$gc_id] : $this->_getTopClass($goods_class, $goods_class[$gc_id]['parent_id']);
    }
    ...
    public function brand_goods() {
        ...
        $brand_info = $model_brand->getBrandInfo(array('brand_id' => $brand_id));
        if (!$brand_info) {
        ...
        $this->assign('show_page', !empty($goods_list)?$model_goods->page_info->render():'');
        // 商品多图
        if (!empty($goods_list)) {
