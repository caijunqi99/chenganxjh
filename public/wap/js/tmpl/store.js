...
$(function() {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/Store/store_info.html",
        data: {
            key: t,
            store_id: e
        },
        ...
        success: function(t) {
            ...
            $("#store_kefu").click(function() {
                window.location.href = WapSiteUrl + "/tmpl/member/chat_info.html?t_id=" + t.result.store_info.member_id
            });
    ...
    $("#goods_rank_tab").find("a").click(function() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/Store/store_goods_rank.html",
            data: {
                store_id: e,
                ordertype: o,
                num: s
            ...
            success: function(e) {
                if (e.code == 200) {
                    var o = template.render("goodsrank_" + t + "_tpl", e.result);
                    $("#goodsrank_" + t).html(o)
                }
            }
        })
    ...
    function s() {
        ...
        o.loadInit({
            url: ApiUrl + "/Store/store_new_goods.html",
            getparam: t,
            tmplid: "newgoods_tpl",
    ...
    function r() {
        $.ajax({
            type: "post",
            url: ApiUrl + "/Store/store_promotion.html",
            data: {
                store_id: e
            },
            dataType: "json",
            success: function(t) {
                t.result.store_id = e;
                var o = template.render("storeactivity_tpl", t);
    ...
    $("#store_voucher").click(function() {
        if (!$("#store_voucher_con").html()) {
            $.ajax({
                type: "post",
                url: ApiUrl + "/Voucher/voucher_tpl_list.html",
                data: {
                    store_id: e,
                    gettype: "points"
                },
                ...
                success: function(t) {
                    if (t.code == 200) {
                        var e = template.render("store_voucher_con_tpl", t.result);
