            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        //新增下级
                        if (data[i].deep < 3) {
                            src += "<a class='btn-add-nofloat marginleft' href='"+SITE_URL+"index.php/Admin/Goodsclass/goods_class_add.html?gc_parent_id=" + data[i].gc_id + "'><span>新增下级</span></a>";
                        }
                        src += "</td>";
                        //是否显示
                        ...
                        //操作
                        src += "<td class='w84'>";
                        src += "<a href='"+SITE_URL+"index.php/Admin/Goodsclass/goods_class_edit.html?gc_id=" + data[i].gc_id + "'>编辑</a>";
                        src += " | <a href=\"javascript:if(confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗'))window.location = '"+SITE_URL+"index.php/Admin/Goodsclass/goods_class_del?gc_id=" + data[i].gc_id + "';\">删除</a>";
                        src += "</td>";
                        src += "</tr>";
                    }
                    //插入
                    ...
                    $.getScript(SITE_URL + "static/admin/js/jquery.goods_class.js");
