...
//        UPLOAD_SITE_URL
        ...
        //获取商品
        $goods = db('goodscommon')->field('goods_commonid,goods_name,goods_jingle,goods_image,goods_price,goods_marketprice,store_id')->order('goods_commend desc')->limit(0,10)->select();
        if(!empty($goods)){
