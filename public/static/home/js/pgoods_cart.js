...
function drop_pcart_item(pcart_id){
    ...
    $.getJSON(SITE_URL+'index.php/home/pointcart/drop?pc_id=' + pcart_id, function(result){
...
function pcart_change_quantity(pcart_id, input){
    ...
    var _v = input.value;
    $.getJSON(SITE_URL+'index.php/home/pointcart/update?pc_id=' + pcart_id + '&quantity=' + _v, function(result){
        if(result.done){
            //更新成功
