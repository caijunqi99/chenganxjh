...
class Goods extends AdminControl
{
    ...
    {
        parent::_initialize();
        Lang::load(APP_PATH . 'school/lang/zh-cn/goods.lang.php');
        //获取当前角色对当前子目录的权限
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'index',
                'text' => '所有商品',
                'url' => url('School/Goods/index')
            ),
            array(
                'name' => 'lockup',
                'text' => '下架商品',
                'url' => url('School/Goods/index',['type'=>'lockup'])
            ),
            array(
                'name' => 'waitverify',
                'text' => '待审核',
                'url' => url('School/Goods/index',['type'=>'waitverify'])
            ),
        );
        return $menu_array;
    }
