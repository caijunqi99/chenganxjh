var store_id = getCookie("store_id");//getQueryString("store_id");
if (store_id == null){
    store_id = 1;
}
...
$(function() {
    ...
    $("#product_list").on("click", '[nc_type="goods_more_link"]',
            function() {
                ...
                $.ajax({
                    type: "post",
                    url: ApiUrl + "/Memberfavorites/favorites_info.html",
                    data: {
                        key: r,
                        fav_id: e
                    },
...
function get_list(e, r) {
    ...
    load_class_storegoodslist.loadInit({
        url: ApiUrl + "/Store/store_goods.html",
        getparam: param,
