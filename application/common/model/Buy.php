...
//            $model_cart->startTrans();
        ...
        //更新收货人所在省份
        \mall\queue\QueueClient::push('editReciverProid', array('order_ids' => array_keys($order_list), 'area_id' => $input_city_id));
    ...
    public function changeAddr($freight_hash, $city_id, $area_id, $member_id) {
        ...
        if ($if_include_platform_store) {
            $allow_offpay = Model('offpayarea')->checkSupportOffpay($area_id, DEFAULT_PLATFORM_STORE_ID);
        }
        //JS验证使用
