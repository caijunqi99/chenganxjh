$(function(){
	...
	//评论提交
	$("[nc_type='scommentbtn']").on('click',function(){
		var data = $(this).attr('data-param');
        eval("data = "+data);
	...
	//删除评论
	$("[nc_type='scomment_del']").on('click',function(){
		var obj = $(this);
	...
	//转发提交
	$("[nc_type='s_forwardbtn']").on('click',function(){
		var data = $(this).attr('data-param');
