...
class Statisticssale extends BaseSeller
{
    ...
    public function index()
    {
       ...
       $this->assign('stattype',$this->search_arr['search_type']);
        ...
        $statcount_arr['orderamount'] = dsPriceFormat(($t = floatval($statcount_arr['orderamount'])) > 0 ? $t : 0);
    ...
    public function buying()
    {
        ...
        $pricerange = Model('storeextend')->getfby_store_id(session('store_id'), 'orderpricerange');
    ...
    protected function getSellerItemList()
    {
        $menu_array = array(
            array(
                'name' => 'sale', 'text' => '销售统计', 'url' => url('statisticssale/index')
            ),  array(
                'name' => 'area', 'text' => '区域分布', 'url' => url('statisticssale/area')
            ),  array(
                'name' => 'buying', 'text' => '购买分析', 'url' => url('statisticssale/buying')
            ),
        );
        return $menu_array;
    }
