...
class Db extends AdminControl {
    ...
    public function _initialize() {
        ...
        Lang::load(APP_PATH . 'office/lang/zh-cn/db.lang.php');
    }
    ...
    public function optimize() {
        ...
        $this->success("优化表成功" . $strTable, url('office/Db/db'));
    }
    ...
    public function repair() {
        ...
        $this->success("修复表成功" . $strTable, url('office/Db/db'));
    }
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'db',
                'text' => '数据备份',
                'url' => url('office/Db/db')
            ),
            array(
                'name' => 'restore',
                'text' => '数据还原',
                'url' => url('office/Db/restore')
            ),
            // array(
            //     'name' => 'ctrl',
            //     'text' => '后台控制',
            //     'url' => url('office/Db/ctrl')
            // ),
        );
