...
class Goods extends Model {
    ...
    public function addGoods($insert) {
        $result = db('goods')->insertGetId($insert);
        if ($result) {
    ...
    public function addGoodsCommon($insert) {
        return db('goodscommon')->insertGetId($insert);
    }
    ...
    public function addGoodsImagesAll($insert) {
        $result = db('goodsimages')->insertAll($insert);
        if ($result) {
    ...
    public function editGoodsPromotionPrice($condition) {
        ...
        $model_xianshigoods = Model('pxianshigoods');
    ...
    public function delGoods($condition) {
        ...
        if (!empty($goods_list)) {
            ...
            // 删除买家收藏表数据
            db('favorites')->where(array('fav_id' => array('in', $goodsid_array), 'fav_type' => 'goods'))->delete();
            // 删除商品赠品
//            Model('goodsgift')->delGoodsGift(array('goods_id' => array('in', $goodsid_array), 'gift_goodsid'=> array('in', $goodsid_array), '_op' => 'or'));
            ...
            // 删除推荐组合
//            Model('goodscombo')->delGoodsCombo(array('goods_id' => array('in', $goodsid_array), 'combo_goodsid' => array('in', $goodsid_array), '_op' => 'or'));
    ...
    private function _rGoodsCommonCache($goods_commonid, $fields) {
        return rcache($goods_commonid, 'goodscommon', $fields);
    }
    ...
    public function getGoodsDetail($goods_id) {
        ...
        if (!empty($goods_info['groupbuy_info'])) {
            ...
            $goods_info['promotion_price'] = $goods_info['groupbuy_info']['groupbuy_price'];
            $goods_info['down_price'] = dsPriceFormat($goods_info['goods_price'] - $goods_info['groupbuy_info']['groupbuy_price']);
        ...
        if (!empty($goods_info['xianshi_info'])) {
            ...
            $goods_info['promotion_price'] = $goods_info['xianshi_info']['xianshi_price'];
            $goods_info['down_price'] = dsPriceFormat($goods_info['goods_price'] - $goods_info['xianshi_info']['xianshi_price']);
