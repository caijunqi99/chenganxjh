...
class Statindustry extends AdminControl
{
    ...
    public function scale_list(){
        ...
        if($gc_childarr){
            ...
            $goods_list = $model->statByStatordergoods($where, $field, 0, 0, $orderby, 'gc_id');
    ...
    public function general_list(){
        ...
        if ($gc_childarr){
            ...
            foreach ($gc_childarr as $k=>$v){
                ...
                $tmp['priceavg'] = dsPriceFormat(($t = $goods_list[$v['gc_id']]['priceavg'])?$t:0);
        ...
        return $this->fetch('listandorder');
    }
