        ...
        if (request()->isPost()) {
            ...
            if ($pid) {
                ...
                if ($result) {
                    ...
                    $this->success($log.'成功', url('School/Playback/playback_manage',['ptype'=>$param['type']]));
                }
            }else{
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'playback',
                'text' => lang('playback'),
                'url' => url('School/Playback/playback_manage',['ptype'=>1])
            ),
            array(
                'name' => 'playback_manage',
                'text' => lang('playback_manage'),
                'url' => url('School/Playback/playback_manage',['ptype'=>2])
            )
        );
