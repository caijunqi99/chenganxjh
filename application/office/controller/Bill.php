...
class Bill extends AdminControl {
    ...
    public function _initialize() {
        parent::_initialize();
        Lang::load(APP_PATH . 'office/lang/zh-cn/bill.lang.php');
    }
    ...
    protected function getAdminItemList() {
        ...
        if (request()->action() == 'show_statis') {
            ...
            $menu_array[] = array(
                'name' => 'show_statis',
                'text' => $title.'商家账单列表',
                'url' => !empty($title) ? url('office/Bill/show_statis',['os_month'=>input('param.os_month')]) : url('office/Bill/show_statis'),
            );
        }
