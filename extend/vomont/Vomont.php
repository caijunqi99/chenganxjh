...
{   
    ...
    */
    public function AaaStorage($accpuntid,$resid){
        ...
        $request = httpRequest($this->http.'msgid='.$msgid.'&accountid='.$accpuntid.'&authkey='.$this->authkey.'&resid='.$resid.'&streamtype=0&time={"weektime":[{"day":0,"timedata":"000000000000001111111111111111111111110000000000"},{"day":1,"timedata":"000000000000001111111111111111111111110000000000"},{"day":2,"timedata":"000000000000001111111111111111111111110000000000"},{"day":3,"timedata":"000000000000001111111111111111111111110000000000"},{"day":4,"timedata":"000000000000001111111111111111111111110000000000"},{"day":5,"timedata":"000000000000001111111111111111111111110000000000"},{"day":6,"timedata":"000000000000001111111111111111111111110000000000"}]}');
        $data = json_decode($request,TRUE);
        return $data;
    }
    /**
